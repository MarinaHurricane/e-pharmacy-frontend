...
import { getProductById } from '@/app/lib/api/client/products';
...
export default function ProductDetailsPage({
  ...
  const handleToggle = () => {
    setMode((prev) => (prev === 'description' ? 'reviews' : 'description'));
  };
      ...
      <section className={css.productDetails}>
        ...
        <div className={css.productInfo}>
          <div className={css.namePrice}>
            ...
            <p className={css.productNamePrice}>{`£ ${product.price}`}</p>
          </div>
        ...
        <div className={css.descriptionWrapper}>
          ...
          {mode === 'description' ? (
            ...
            <ul className={css.reviewsList}></ul>
          )}
        </div>
      </section>
    </>
